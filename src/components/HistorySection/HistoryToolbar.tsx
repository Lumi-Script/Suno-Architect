...
const HistoryToolbar: React.FC<HistoryToolbarProps> = ({ 
    ...
    limit, setLimit, onClearSearch, isShowingSearchResults, onDownloadAll
}) => {
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto items-center">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto bg-slate-900/50 p-1 rounded-lg border border-slate-700">
                ...
                <button
                    ...
                    disabled={isSyncing}
                    title="Download All"
                    className="px-3 py-1.5 rounded-md text-xs font-bold transition-all flex items-center justify-center bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-50"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 sm:mr-1">
